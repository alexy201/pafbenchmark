...
dataset.path=/home/as4296/palmer_scratch/vit/gen1 dataset.downsample_by_factor_2=False hardware.gpus=[0,1,2,3,4,5,6,7] \
batch_size.train=8 batch_size.eval=8 hardware.num_workers.train=2 hardware.num_workers.eval=2 \
